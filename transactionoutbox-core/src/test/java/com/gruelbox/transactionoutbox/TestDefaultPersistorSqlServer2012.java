...
@Testcontainers
class TestDefaultPersistorSqlServer2012 extends AbstractDefaultPersistorTest {
  ...
  private DefaultPersistor persistor =
      DefaultPersistor.builder().dialect(Dialect.SQL_SERVER_2012).build();
  ...
  protected Dialect dialect() {
    return Dialect.SQL_SERVER_2012;
  }
}
